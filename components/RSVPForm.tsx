...
export const RSVPForm = () => {
  ...
  return (
    <section className="absolute max-w-5xl mx-auto inset-0 flex flex-col justify-between p-24">
      <h1 className="tracking-widest self-center mb-10 font-bold text-primary text-[10vw] lg:text-5xl font-brush">
        RSVP
      </h1>
