    ...
    <div className="relative">
      ...
      <header className="flex h-screen flex-col z-10 content-center justify-center">
        ...
        <div className="flex justify-center content-center">
          <div className="bg-primary bg-opacity-40 w-full h-[1px] self-center" />
        ...
        <button
          className="self-center  mt-10 font-thin text-gray-300 cursor-pointer text-xl md:text-3xl border-2 border-primary border-opacity-40 w-64 py-4 px-8 z-50"
          onClick={() => {
