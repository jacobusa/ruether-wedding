...
export const RSVPFormDataSchema = z.object({
  ...
  mealSelection: z.enum(["Chicken", "Steak", "Vegetarian"]),
  plusOneMealSelection: z.enum(["Chicken", "Steak", "Vegetarian"]).optional(),
...
export const UserDataSchema = z.object({
  ...
  coupleFirstName: z.string().optional(),
  coupleLastName: z.string().optional(),
  coupleEmail: z.string().optional(),
});
